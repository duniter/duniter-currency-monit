...
module.exports = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const sentries = yield Promise.all(pointsDeControle.map((wotb_id) => __awaiter(void 0, void 0, void 0, function* () {
            const identite = yield dataFinder.getIdentityByWotbid(wotb_id);
        ...
        if (req.query.to) {
            ...
            let idties = yield dataFinder.searchIdentities(search);
            idty = idties[pos];
            if (!idty) {
                searchResult = `
                ...
                let membres = yield prepareMembresInitiaux(dataFinder, wotb, dSen, sentries, dicoIdentites, duniterServer);
...
function prepareMembresInitiaux(dataFinder, wotb, dSen, sentries, dicoIdentites, duniterServer) {
    return __awaiter(this, void 0, void 0, function* () {
        // Ajout des membres non-sentries
        const pointsNormaux = wotb.getNonSentries(dSen);
        const nonSentries = yield Promise.all(pointsNormaux.map((wotb_id) => __awaiter(this, void 0, void 0, function* () {
            const identite = yield dataFinder.getIdentityByWotbid(wotb_id);
        ...
        const disabled = yield Promise.all(nonMembres.map((wotb_id) => __awaiter(this, void 0, void 0, function* () {
            const identite = yield dataFinder.getIdentityByWotbid(wotb_id);
