...
(req, res) => res.render('willMembers.html', {
    printMenu,
    help: req.query.help,
    MENU_LANG: getLang(`${__dirname}/../lg/menu_${req.query.lg || constants.DEFAULT_LANGUAGE}.txt`),
...
* Lister les membres
***************************************/
app.get('/members', require(__dirname + '/members2.js'), (req, res) => res.render('members.html', {
    printMenu,
    help: req.query.help,
    MENU_LANG: getLang(`${__dirname}/../lg/menu_${req.query.lg || constants.DEFAULT_LANGUAGE}.txt`),
...
***************************************/
app.get('/membersCount', require(__dirname + '/../lib/updateCache2.js'), require(__dirname + '/membersCount2.js'), (req, res) => res.render('Chart.html', {
    printMenu,
...
* Wotex
***************************************/
app.get('/wotex', require(__dirname + '/wotex2.js'), (req, res) => res.render('wotex.html', {
    printMenu,
    help: req.query.help,
    MENU_LANG: getLang(`${__dirname}/../lg/menu_${req.query.lg || constants.DEFAULT_LANGUAGE}.txt`),
...
********************************************/
app.get('/gaussianWotQuality', require(__dirname + '/gaussianWotQuality2.js'), (req, res) => res.render('Chart.html', {
    printMenu,
...
***************************************/
app.get('/blockCount', require(__dirname + '/blockCount2.js'), (req, res) => res.render('Chart.html', {
    printMenu,
...
***************************************/
app.get('/monetaryMass', require(__dirname + '/monetaryMass2.js'), (req, res) => res.render('Chart.html', {
    printMenu,
...
module.exports = app;
//# sourceMappingURL=alternate_index.js.map