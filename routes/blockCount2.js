...
module.exports = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (end < 0) {
            ...
            newBlocks = yield dataFinder.getBlockWhereMedianTimeLteAndGt(endBlock.medianTime, previousBlockchainTime);
        ...
        for (let m = 0; m < tabBlockMembers.length; m++) {
            ...
            tabBlockMembersSort.push({
                ...
                pubkey: tabBlockMembers[idMax].pub || tabBlockMembers[idMax].pubkey,
                ...
                if (tabBlockMembersSort[m].data > 0) {
                    if (perNode == 'yes') {
                        ...
                        for (let n = 0; n < maxSignificantIdNode; n++) {
                            ...
                            if (tabBlockMembersSort[m].coreCountPerNode[n] > 0) {
                                tabLabels[tabLabels.length - 1] += tabBlockMembersSort[m].coreCountPerNode[n] + "c,";
                            }
                        }
