  ...
  ***************************************/
  ...
  app.get('/willMembers', (req, res) => co(function *() {
	...
	// Afficher le formulaire
	  ...
	  contenu += '>'+tabTxt["CHECKBOX_HIDE_IDTY_WITH_ZERO_CERT"]+'</form><br>';
	  ...
	  contenu += '<br><br>';
	  contenu += '<b>'+tabTxt["BLOCKCHAIN_TIME"]+' : '+timestampToDatetime(currentBlockchainTimestamp)+'.</b><br>';
	  
	  // On parcour toutes les identités
	  var nbPrintMembers = 0;
	  contenu += tabTxt["TABLE_TITLE1"]+' '+days+' '+tabTxt["TABLE_TITLE2"]+' :<table border=1>';
