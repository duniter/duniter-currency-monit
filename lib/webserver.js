  ...
  app.get('/monetaryMass', (req, res) => co(function *() {
	...
	if (blockchain[b].monetaryMass != previousMonetaryMass)
	{
	  tabCurrency.push({
	    ...
	    relativMonetaryMassPerMembers: 0
	  });
      ...
      {
	tabCurrency[i].relativMonetaryMass = (tabCurrency[i].monetaryMass / currentDividend) * 100;
	tabCurrency[i].relativMonetaryMassPerMembers = (tabCurrency[i].monetaryMassPerMembers / currentDividend) * 100;
      }
