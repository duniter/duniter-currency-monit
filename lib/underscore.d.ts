...
export declare const Underscore: {
    ...
    where: <T_1>(elements: T_1[], props: { [k in keyof T_1]?: T_1[k] | undefined; }) => T_1[];
    findWhere: <T_2>(elements: T_2[], props: { [k_1 in keyof T_2]?: T_2[k_1] | undefined; }) => T_2 | null;
    ...
    uniq: <T_8, K_3>(elements: T_8[], isSorted?: boolean, iteratee?: ((t: T_8) => K_3) | undefined) => T_8[];
    clone: <T_9>(t: T_9) => T_9;
    ...
    range: (count: number, end?: number | undefined) => number[];
